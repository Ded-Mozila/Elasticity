...
public:
	...
	vector<double> Iterat1(vector<vector<double> > A, vector<double> B, int N, double eps, double alfa, int n, double h);
	vector<double> Iterat2(vector<vector<double> > A, vector<double> B, int N, double eps, double alfa);
