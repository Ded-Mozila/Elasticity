...
int main()
{
	...
	new_list_T.push_back(CT1_1);
		map<int,double>  CT2_1; // Второй интеграл
		CT2_1[0] = -1;
		CT2_1[1] =  0.5;
		CT2_1[2] = -0.5;
		CT2_1[3] =  0.5;
	...
	new_list_T.push_back(CT2_1);
		map<int,double>  CT1_2; // Третий интеграл
		CT1_2[0] =  2;
		CT1_2[1] =  0;
		CT1_2[2] =  0;
		CT1_2[3] = -1;
	...
	new_list_T.push_back(CT1_2);
		map<int,double>  CT2_2; // Четвёртый интеграл
		CT2_2[0] = -1;
		CT2_2[1] =  0.5;
		CT2_2[2] = -0.5;
		CT2_2[3] =  0.5;
  ...
  new_list_T.clear(); // Очистка лита
	...
	new_list_T.push_back(LT1_1);
		map<int,double>  LT2_1; // Второй интеграл
		LT2_1[0] = -0.5;
		LT2_1[1] =  0.5;
		LT2_1[2] = -0.5;
		LT2_1[3] =  0;
	...
	new_list_T.push_back(LT2_1);
		map<int,double>  LT1_2; // Теретий интеграл
		LT1_2[0] =  1;
		LT1_2[1] =  0;
		LT1_2[2] =  0;
		LT1_2[3] = -0.5;
	...
	new_list_T.push_back(LT1_2);
		map<int,double>  LT2_2; // Четвёртый интеграл
		LT2_2[0] = -0.5;
		LT2_2[1] =  0.5;
		LT2_2[2] = -0.5;
		LT2_2[3] =  0.5;
   ...
   new_list_T.clear(); // Очистка лита
	...
	new_list_T.push_back(RT1_1);
		map<int,double>  RT2_1; // Второй интеграл
		RT2_1[0] = -0.5;
		RT2_1[3] =  0.5;
		RT2_1[4] =  0.5;
		RT2_1[5] = -0.5;
	...
	new_list_T.push_back(RT2_1);	
		map<int,double>  RT1_2; // Теретий интеграл
		RT1_2[0] =  1;
		RT1_2[3] = -0.5;
		RT1_2[4] =  0;
		RT1_2[5] =  0;
	...
	new_list_T.push_back(RT1_2);	
		map<int,double>  RT2_2; // Четвёртый интеграл
		RT2_2[0] = -0.5;
		RT2_2[3] =  0;
		RT2_2[4] =  0.5;
		RT2_2[5] = -0.5;
